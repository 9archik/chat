...
export class Migrate11698764589004 implements MigrationInterface {
    name = 'Migrate11698764589004'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "users_in_room" ADD "roomId" integer`);
        await queryRunner.query(`ALTER TABLE "users_in_room" ADD CONSTRAINT "UQ_5bf04e06e0a63386184dabf32db" UNIQUE ("roomId")`);
        await queryRunner.query(`ALTER TABLE "users_in_room" ADD "userId" integer`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users_in_room" DROP COLUMN "userId"`);
        await queryRunner.query(`ALTER TABLE "users_in_room" DROP CONSTRAINT "UQ_5bf04e06e0a63386184dabf32db"`);
        await queryRunner.query(`ALTER TABLE "users_in_room" DROP COLUMN "roomId"`);
    }
